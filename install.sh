...
echo "curl --data '{\"client\": ${CLIENT_ID}, \"IP\": \"\${IP_ADDRESS}\"}' -H 'Authorization: ${AUTH_KEY}' -H 'Content-type: application/json' http://${COMMAND_CONTROL_HOST}:8000/api/reportIP" >> reportIp.sh
